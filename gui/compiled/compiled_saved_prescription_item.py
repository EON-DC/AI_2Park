...
class Ui_Saved_Prescription_Item(object):
    def setupUi(self, Saved_Prescription_Item):
        ...
        Saved_Prescription_Item.resize(900, 128)
...
"}")
        ...
        self.widget_2.setMinimumSize(QtCore.QSize(300, 128))
        self.widget_2.setMaximumSize(QtCore.QSize(300, 128))
        ...
        self.label_saved_time.setScaledContents(False)
    ...
    def retranslateUi(self, Saved_Prescription_Item):
        ...
        self.label_saved_time.setText(_translate("Saved_Prescription_Item", "최초저장일시: 2023-08-26 13:11"))
